<nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          ...
          <!-- <a class="sidebar-brand brand-logo-mini" style="height:20px;" href="index.html"><img src="admin/assets/images/logo.png" alt="logo" /></a> -->
        </div>
        <ul class="nav">
        
          <li class="nav-item nav-category">
            <span class="nav-link">Admin Dashboard Navigation</span>
          </li>
